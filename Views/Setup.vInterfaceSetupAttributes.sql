...
SELECT        Setup.tblProcessMachines.ProcessID,
						 ...
						 ,tblProcessMachines.ProcessID AS PssProcessID, ToleranceReq, ToleranceUOM, ToleranceType,DefaultMinTol, DefaultMaxTol, DefaultMinValueTol, DefaultMaxValueTol
