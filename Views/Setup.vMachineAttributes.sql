...
SELECT        Setup.ApsSetupAttributes.AttributeName, Setup.MachineGroupAttributes.LogicType, Setup.ApsSetupAttributeValueType.ValueTypeName, 
                         Setup.ApsSetupAttributeValueType.ValueTypeDescription, Setup.MachineGroup.MachineGroupName, Setup.MachineNames.MachineName, 
						 ...
						 setup.MachineGroupAttributes.ApsData
