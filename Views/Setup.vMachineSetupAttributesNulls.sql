...
AS(
	...
	FROM            Setup.vMachineAttributes AS K INNER JOIN
							 ...
							 Setup.vMachineCapability AS P ON P.MachineID = K.MachineID LEFT JOIN
							 Setup.vInterfaceSetupAttributes AS I ON G.AttributeID = I.AttributeID AND I.PssMachineID = K.MachineID AND I.SetupNumber = P.Setup 
)
SELECT *
FROM cteSetup
