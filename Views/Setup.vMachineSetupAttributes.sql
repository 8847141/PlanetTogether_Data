...
AS
	...
	FROM            Setup.vMachineAttributes AS K INNER JOIN
							 ...
							 Setup.vMachineCapability AS P ON P.machineID = K.machineID INNER JOIN
							 Setup.vInterfaceSetupAttributes AS I ON G.AttributeID = I.AttributeID AND I.PssMachineID = p.PssMachineID AND I.SetupNumber = P.Setup 
